  ...
  return (
    <section id="how-it-works" className="py-28 px-6 md:px-16 bg-white">
      <div className="max-w-4xl mx-auto">
        <p className="text-green-600 text-xs font-semibold uppercase tracking-widest mb-5">작동 방식</p>
        <h2 className="text-4xl font-bold text-gray-900 mb-16">딱 세 단계예요</h2>

        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((s) => (
            <div key={s.number}>
              <div className="text-green-200 text-5xl font-black mb-5 leading-none">{s.number}</div>
        ...
        <div className="mt-16 border border-gray-100 rounded-2xl p-7">
          ...
          <div className="flex flex-wrap gap-2.5">
            {[
              ...
              <span key={c} className="border border-gray-200 text-gray-500 text-xs px-4 py-2 rounded-full hover:border-green-300 hover:text-green-700 transition-colors cursor-default">
                {c}
              </span>
            ))}
          </div>
